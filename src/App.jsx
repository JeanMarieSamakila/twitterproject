...
// import Postetableau from "./Postetableau";
  ...
  return (
    <>
      <div className=" flex justify-center ml-20">
        <div id="container1" className=" w-2/12 space-x-2">
          <div className="Bar">
            <Bar src="images/Twitter.svg" />
            <Link to="/Home">
              <Bar src="images/Home-Fill.svg" name="Home" />
            </Link>
            <Bar src="images/Explore.svg" name="Explore" />
            <Bar src="images/Notifications.svg" name="Notification" />
            <Bar src="images/Messages.svg" name="Messages" />
            <Bar src="images/Bookmarks.svg" name="Bookmarks" />
            <Bar src="images/Lists.svg" name="Listes" />
            <Link to="/Profile">
              <Bar src="images/Profile.svg" name="Profile" />
            </Link>

            <Bar src="images/More.svg" name="More" />
          </div>
          <section id="boutontweet">
            <button className="hover:bg-gradient-to-r from-green-400 to-blue-400 justify-center ml-5 bg-blue-500 rounded-3xl h-12 w-32 mt-5">
              Tweet
            </button>
          </section>
        ...
        <div id="" className=" border border-slate-800 w-5/12">
          {/* <Header />
          <Tweet />
          {tableau.map((tab) => (
            <Postetableau props={tab} />
          ))} */}
          <Routes>
        ...
        <div className="w-3/12 h-screen">
          <div class=" ml-5 bg-gray-900 flex w-96 h-10 rounded-3xl border-solid border-black p-2 ">
            <div>
